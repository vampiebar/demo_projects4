<?php 
/*if($_SERVER['HTTPS']){
     $url = 'http://www.secpayazilim.com/indir';
     header("Location: $url");
}
*/
session_start();
...
<meta name="description" content="Seçpa Yazılım ve İnternet Teknolojileri İndirme Sayfası" />
...
<title>Seçpa Yazılım | İndir</title>
	...
	<div class="container">
        ...
        <div class="span9 marginforheader">
        	<ul class="nav nav-pills pull-right">
                ...
                <li class="active"><a href="../download" title="Seçpa Yazılım Download"><?php echo $dil["menu7"]; ?></a></li>
...
<div class="row-fluid">
  ...
  <li class="span4">
    <div class="thumbnail">
      ...
      <p class="text-center">
      <a href="http://workviewer.com/download.php" class="btn btn-warning btn-large"><?php  echo $dil["ucretsiz_indir"]; ?></a>
      </p>
    </div>
  </li>
  <li class="span4">
    <div class="thumbnail" style="height:545px;">
      ...
      <p class="text-center">
      <a href="../kidsviewer" class="btn btn-warning btn-large"><?php  echo $dil["ucretsiz_indir"]; ?></a>
      </p>
    </div>
  </li>
  <li class="span4">
    <div class="thumbnail">
      ...
      <p class="text-center">
      <a href="#" class="btn btn-warning btn-large"><?php  echo $dil["ucretsiz_indir"]; ?></a>
      </p>
    </div>
  </li>
</ul>
