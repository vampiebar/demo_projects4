...
<TABLE cellSpacing=0 cellPadding=0 width=649 border=0>
  ...
  <TR>
    <TD><div align="center"><FORM id=FRM name=FRM 
      action=posttib.asp method=post onSubmit="return form_control_ex();">
      <TABLE cellSpacing=2 cellPadding=2 width=100% border=0>
        ...
        <TR vAlign=top align=left>
          ...
          (Her Pc için Ayrı Lisans Alınmalıdır. En Az 15 Client Alınabilir.) </strong></p></td>
                    <td><input name="ADET" id="ADET"  onKeyUp="DoToplam()"  type="text" value="9" size="3" maxlength="3" style="text-align:center; FONT-WEIGHT: bold; COLOR: black" autocomplete="off">
