...
<div align="center">
  <table width="449" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td valign="top"><form id="FRM" name="FRM" method="post" action="nvformozel.php" onSubmit="return form_control_ex();">
      ...
      <tr bgcolor="#FFFFFF">
        <td height="59" bgcolor="#FFFFFF" class="style1"><div align="center" class="style12"><br />
            ...
            <input type="hidden" name="subject" value="Kredi Kartı ile Satış Formu">
            </span><br />
            ...
            name="vdaire" style="FONT-WEIGHT: bold; COLOR: black; TEXT-ALIGN: left" autocomplete="off"/>
                  ...
                  <td><span class="style16">
                    <input 
            name="vno" class="style9" id="vno" maxlength="13" style="FONT-WEIGHT: bold; COLOR: black; TEXT-ALIGN: left" autocomplete="off"/>
                    * </span></td>
                </tr>
                <tr valign="top" align="left">
