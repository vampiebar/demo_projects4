...
.style52 {font-family: "Trebuchet MS"; font-size: 14px; color: #FF0000; }
</STYLE>
...
<TABLE cellSpacing=0 cellPadding=0 width=649 border=0>
  ...
  <TR>
    <TD><div align="center"><FORM id="FRM" name="FRM" action="sanal_pos.php?ptype=ND&renew=true" method="post" onSubmit="return form_control_ex();">
      <TABLE cellSpacing=2 cellPadding=2 width=100% border=0>
        ...
        <TR vAlign=top align=left>
          <TD colspan="2" scope=row><table width="100%" border="0" cellspacing="3" cellpadding="3">
            <tr>
              <td bgcolor="#990000"><div align="center"><span class="style25">KÝÞÝSEL BÝLGÝLERÝNÝZ</span></div></td>
            </tr>
            <tr>
              <td class="style1 style46 style47"><div align="center" class="style50">Yenileme iþlemini gerçekleþtirebilmeniz için bilgilerinizi yeniden girmeniz gereklidir. Lütfen aþaðýda &quot;*&quot; ile belirtilmiþ alanlarý eksiksiz doldurunuz.</div></td>
            </tr>
            
            <tr>
              <td width="100%"><table width="400" border="0" align="center" cellpadding="2" cellspacing="2">
...
<tr valign="top" align="left">
                              <td align="center" class="style38 style49 style51" scope="row"><? echo $_SESSION['dbData']['dbGuid']; ?></td>
                                <td colspan="2" align="center" scope="row"><span class="style48 style51">
                            <?
                              	if(@$Expired == true) {
                            ...
                            <tr valign="top" align="left">
                              <td align="center" class="style38 style45" scope="row"><span class="style52"><? echo $Expire; ?></span></td>
                              <td align="center" class="style38 style45" scope="row"><span class="style52"><? echo $ExpireNew; ?></span></td>
                            ...
                            <tr valign="top" align="left">
                              <td colspan="2" align="center" class="style38 style45" scope="row"><span class="style52"><? echo $Update; ?></span></td>
                            </tr>
                  <tbody>
                    <tr align="left" valign="top" bgcolor="#CFCFCF">
                    ...
                    <tr valign="top" align="left">
                      <td scope="row" width="200"><span class="style16">
                        <input name="Adi" class="style9" id="Adi" style="FONT-WEIGHT: bold; COLOR: black; TEXT-ALIGN: left"/>
                        *</span></td>
