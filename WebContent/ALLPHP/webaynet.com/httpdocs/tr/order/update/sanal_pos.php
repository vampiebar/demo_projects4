...
$phone		= $_POST['telefon'];
$gsm		= $_POST['GSM'];
$country	= $_POST['pr_ulke'];
$company	= $_POST['unvan2'];
$city		= $_POST['sehir'];
...
if($_GET['ptype'] == "NC") { $L = "netckkform.php"; }
?>
...
<table width="400" border="0" align="center" cellpadding="3" cellspacing="3" style="border: 1px solid #CFCFCF;">
  <tr>
    <td colspan="2" bgcolor="#EFEFEF" class="style8">:: Güncelleme Başarılı</td>
  </tr>
  <tr>
    <td width="1"><img src="images/Disapprove.png" alt="" width="72" height="72" align="middle" /></td>
    <td width="387"><p align="center">      Güncelleme işleminiz <span class="style22">başarılı</span> bir şekilde sonuçlanmıştır. Güncellemeniz ile ilgili detaylı bilgiler <b> <? echo @$_POST['email']; ?> </b>  mail adresine gönderilmiştir. Bir problem yada sorun ile karşılaşırsanız Lütfen <a href="mailto:support@webaynet.com">destek@webaynet.com</a> adresine bilgi veriniz.</p></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><span class="style3"><img src="images/webaynetlogo.png" alt="" width="224" height="62" /></span></td>
  </tr>
  <tr>
