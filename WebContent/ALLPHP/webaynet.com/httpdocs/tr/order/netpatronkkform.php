...
<TABLE cellSpacing=0 cellPadding=0 width=649 border=0>
  ...
  <TR>
    <TD><div align="center"><FORM id=FRM name=FRM action="https://www.moneybookers.com/app/payment.pl" method="post" onSubmit="return form_control_ex();">
      <TABLE cellSpacing=2 cellPadding=2 width=100% border=0>
        ...
        <TR vAlign=top align=left>
          <TD colspan="2" scope=row><input type="hidden" name="pay_to_email" value="bulent@webaynet.com">
            ...
            <input type="hidden" name="detail1_text" value="NETPATRON NETWORK CONTROL SOFTWARE"></TD>
        </TR>
        <TR vAlign=top align=left>
