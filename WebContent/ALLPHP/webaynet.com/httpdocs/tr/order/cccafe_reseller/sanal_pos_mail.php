...
$MailDone = false;
$WorkingDir = "tr/order/cccafe_reseller";
$Subject = "TIB SÜRÜMÜ KREDI KARTI ILE BAYII SIPARIS FORMU";
$Headers = "MIME-Version: 1.0" . "\r\n";
$Headers.= "Content-type:text/html;charset=iso-8859-9" . "\r\n";
$Headers.= 'From: WEBAYNET Software <register@webaynet.com>' . "\r\n";
$Headers.= 'Reply-to: <info@webaynet.com>' . "\r\n";
$Headers.= 'BCC: bulentseker@gmail.com,info@webaynet.com,engin.mihcioglu@gmail.com,aliyakupturanoglu@mynet.com' . "\r\n";
