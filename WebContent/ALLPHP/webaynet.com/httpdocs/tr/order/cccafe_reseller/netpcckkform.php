    ...
    <TD><div align="center"><FORM id="FRM" name="FRM" action="sanal_pos.php" method="post" onSubmit="return form_control_ex();">
      <TABLE cellSpacing=2 cellPadding=2 width=100% border=0>
        ...
        <TR vAlign=top align=left>
          <TD width="186%" colSpan=2 align="center" vAlign=center scope=row><img src="../../images/90YTL.jpg" alt="" width="541" height="239">
            <input name="fiyat" type="hidden" id="GENTOP" value="90"></TD></TR>
