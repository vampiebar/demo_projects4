          ...
          <tr>
              ...
              <tr>
                <td align="center"><table width="649" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><div align="center">
                      <div align="center">
                        <form name="FRM"  method="post" action="http://www.webaynet.com/scripts/formmail/nvform12.php" id="formID" class="formular">
                          <table width="600"  border="0" cellspacing="2" cellpadding="2">
                            <tr align="left" valign="bottom">
                              <td colspan="2" scope="row"><span class="style16">
                                ...
                                <input type="hidden" name="subject" value="NETPATRON (PAKETİÇİ EK PC) KREDİ KARTI SİPARİŞ FORMU" />
                              </span></td>
                            </tr>
                            <tr align="left" valign="top">
                              <td colspan="2" scope="row"><div align="center" class="style20">L&Uuml;TFEN AŞAĞIDAKİ BİLGİLERİ DOLDURUNUZ. &Ouml;DEME İŞLEMİ BİR SONRAKİ SAYFADA YAPILACAKTIR.<br />
                                <img src="images/ekpc.png" width="116" height="115" /> </div></td>
                            </tr>
                            <tr align="left" valign="top">
                            ...
                            <tr align="left" valign="top">
                              <td width="54%" align="right" bgcolor="#E1E1E1" scope="row"><strong class="style37"><span class="style31">LİSANS YENİLEMESİ YAPIYORSANIZ AKTİVASYON KODUNUZ</span><br />
                                (Ürünümüzü; ilk kez alıyorsanız boş bırakınız)</strong></td>
            ...
            name="vno2" class="validate[required] text-input" id="vno2" maxlength="11" style="FONT-WEIGHT: bold; COLOR: black; TEXT-ALIGN: left" autocomplete="off"/>
                                      ...
                                      <tr valign="top" align="left">
                                        ...
                                        <td class="style37"><strong class="style37"> VARSA ÖZEL MESAJINIZ</strong><br />
        ...
        <td width="948" height="123" align="center"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="96%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td colspan="3" align="center" class="TEXT2"><a href="index.php" class="TEXT2"><strong>Ana Sayfa</strong></a><strong> | <a href="urunlerimiz.php">Ürünlerimiz </a>| <a href="yukle.php">Yükle</a> | <a href="destek.php">Destek</a> | <a href="satinal.php" class="TEXT2">Satın Al</a> | <a href="hakkimizda.php" >Hakkımızda</a> | <a href="basindabiz.php">Basında Biz</a> | <a href="iletisim.php">İletişim</a> | <a href="site-kullanim-gizlilik.php">Site Kullanım Şartları</a></strong></td>
              </tr>
              <tr>
üretmiş olduğu Netdadı içerik filtreleme programı ile gençlerimizi ve çocuklarımızı internetin ve bilgisayarın zararlı etkilerinden koruyabilirsiniz. Ayrıca Netpatron isimli network yönetim ve izleme uygulaması ile şirketinizde, okulunuzda, hastaneniz de kısaca Bilgisayar ve internetin olduğu heryerde kullanıcıların yönetimi, kontrolü ve izlenmesi gibi bir çok işlemi de yapabilirsiniz.</td>
              </tr>
              <tr>
