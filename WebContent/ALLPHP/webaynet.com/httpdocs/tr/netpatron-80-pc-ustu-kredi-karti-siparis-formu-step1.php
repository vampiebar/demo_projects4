              ...
              <tr>
                <td align="center"><table width="649" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><div align="center">
                      <div align="center">
                        <form name="FRM"  method="post" action="http://www.webaynet.com/scripts/formmail/nvform10.php" id="formID" class="formular">
                          <table width="600"  border="0" cellspacing="2" cellpadding="2">
                            <tr align="left" valign="bottom">
                              <td colspan="2" scope="row"><span class="style16">
                                ...
                                <input type="hidden" name="subject" value="NETPATRON (80 PC YE KADAR) KREDİ KARTI SİPARİŞ FORMU" />
                              </span></td>
                            </tr>
                            <tr align="left" valign="top">
                              <td colspan="2" scope="row"><div align="center" class="style20">LÜTFEN AŞAĞIDAKİ BİLGİLERİ DOLDURUNUZ. ÖDEME İŞLEMİ BİR SONRAKİ SAYFADA YAPILACAKTIR.<br />
                                <img src="images/80pc.png" width="110" height="112" /> </div></td>
                            </tr>
                            <tr align="left" valign="top">
