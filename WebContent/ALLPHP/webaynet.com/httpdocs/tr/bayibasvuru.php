...
<table width="962" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center"><img src="images/bayibasbaslik.jpg" width="962" height="40" /></td>
  </tr>
  <tr>
    <td align="center" background="images/bigtablebacround.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="2%">&nbsp;</td>
        <td width="96%" align="center"><iframe frameborder="0" marginwidth="0" marginheight="0" scrolling="No" src="bayibasformu.html" width="610" height="700"
             > </iframe></td>
        <td width="2%">&nbsp;</td>
      </tr>
    </table></td>
