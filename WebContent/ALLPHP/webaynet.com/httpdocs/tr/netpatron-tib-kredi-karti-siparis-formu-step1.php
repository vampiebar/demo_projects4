...
<table width="962" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center"><img src="images/tibsipbaslik.png" width="962" height="40" /></td>
  </tr>
  <tr>
        ...
        <td width="70%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
              ...
              <tr>
                <td align="center"><table width="649" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><div align="center">
                      <div align="center">
                        <form name="FRM"  method="post" action="http://www.webaynet.com/scripts/formmail/nvform2.php" id="formID" class="formular">
                          <table width="600"  border="0" cellspacing="2" cellpadding="2">
                            <tr align="left" valign="bottom">
                              <td colspan="2" scope="row"><span class="style16">
                                ...
                                <input type="hidden" name="subject" value="TİB ONAYLI NETPATRON KREDİ KARTI SİPARİŞ FORMU" />
                              </span></td>
                            </tr>
                            <tr align="left" valign="top">
                              <td colspan="2" scope="row"><div align="center" class="style20">L&Uuml;TFEN AŞAĞIDAKİ BİLGİLERİ DOLDURUNUZ. &Ouml;DEME İŞLEMİ BİR SONRAKİ SAYFADA YAPILACAKTIR.</div></td>
                            </tr>
                            <tr align="left" valign="top">
            ...
            class="style37" id="gui" maxlength="16" style="FONT-WEIGHT: bold; COLOR: black; TEXT-ALIGN: left" autocomplete="off"/>
                              </span><strong class="style37">(&Ouml;rneğin: CC09123456789456)</strong></td>
                            </tr>
                            <tr align="left" valign="top">
            ...
            name="vno2" class="validate[required] text-input" id="vno2" maxlength="11" style="FONT-WEIGHT: bold; COLOR: black; TEXT-ALIGN: left" autocomplete="off"/>
                                      ...
                                      <tr valign="top" align="left">
                                        <td scope="row">&nbsp;</td>
                                        <td><input name="submit" type="submit" class="style37" id="Submit" value="İŞLEMİ TAMAMLA &Ouml;DEME SAYFASINA GE&Ccedil; &gt;&gt;" /></td>
                                      </tr>
                                      <tr valign="top" align="left">
