...
if (FRM.tcno.value == '') {
alert("LÜTFEN T.C. NUMARANIZI GİRİNİZ, FATURA BİLGİLERİ İÇİN GEREKLİDİR.");
FRM.tcno.focus();
return false;  
}
      ...
      <tr bgcolor="#FFFFFF">
        <td height="59" bgcolor="#FFFFFF" class="style1"><div align="center" class="style12"><br />
            ...
            class="style9" id="tcno" maxlength="12" style="FONT-WEIGHT: bold; COLOR: black; TEXT-ALIGN: left" autocomplete="off"/>
                ...
                <tr valign="top" align="left">
                  <td scope="row"><div align="right"><strong class="style9">ŞİRKET İSENİZ FİRMA YA DA KURUM ADI</strong></div></td>
                  <td><span class="style16">
