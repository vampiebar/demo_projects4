...
<title>Internet Filtresi, aile koruma şifresi programıı, Tib Onaylı Filtre programı, Network Kontrol Programı, Webaynet | Netdadı | Netpatron</title>
<link rel="icon" href="http://www.webaynet.com/favicon.gif" type="image/gif" >
<META NAME="description" content="NETDADI web filtre programının banka havalesi ile siparişi." >
...
<table width="962" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center"><img src="images/images6.jpg" width="962" height="200" /></td>
  </tr>
  <tr>
    <td align="center"><img src="images/netdadihavalebaslik.jpg" width="962" height="40" /></td>
  </tr>
  <tr>
        ...
        <td width="70%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
                        ...
                        <form name="FRM"  method="post" action="http://www.webaynet.com/scripts/formmail/nvform.php" id="formID" class="formular">
                          <table width="600"  border="0" cellspacing="2" cellpadding="2">
                            ...
                            <tr align="left" valign="top">
                              <td colspan="2" scope="row"><div align="center" class="style20">L&Uuml;TFEN HAVALE YAPTIĞINIZ YADA YAPACAĞINIZ BANKAMIZI SE&Ccedil;İNİZ ! </div></td>
                            </tr>
                            <tr align="left" valign="top">
                            ...
                            <tr align="left" valign="top">
                              <td colspan="2" scope="row"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td colspan="7" align="center" bgcolor="#CCCCCC" class="style20">NETDADI INTERNET FILTER VE PC KONTROL YAZILIMI</td>
                                </tr>
                                <tr>
                                  <td colspan="7" align="center"><img src="images/ndfiyat.png" width="112" height="112" /></td>
                                  </tr>
                                <tr>
                                  <td align="center">&nbsp;</td>
                                  <td align="center">&nbsp;</td>
                                ...
                                <tr>
                                  <td colspan="7" align="left"><ul>
                                    <li> <span class="style37">Lisanslarımız 1 Yıllık Kullanım lisanslarıdır.</span></li>
                                    <li><span class="style37">Bir Sonraki yıllardaki alımlarda %35 indirim uygulanır.</span><br />
                                    </li>
                                  </ul></td>
                                </tr>
                              </table></td>
                            ...
                            <tr align="left" valign="top">
                              <td align="right" bgcolor="#E1E1E1" class="style31" scope="row"><strong>ŞU ANKİ IP ADRESİNİZ</strong></td>
                              <td bgcolor="#E1E1E1"><span class="style16"><span class="style161"><font face="Verdana" size="2">
            ...
            class="style37" id="gui" maxlength="16" style="FONT-WEIGHT: bold; COLOR: black; TEXT-ALIGN: left" autocomplete="off"/>
                                ...
                                <strong class="style37">(&Ouml;rneğin: ND12123456789456)</strong></td>
                            </tr>
                            <tr align="left" valign="top">
            ...
            name="vdaire" style="FONT-WEIGHT: bold; COLOR: black; TEXT-ALIGN: left" autocomplete="off"/>
                                        ...
                                        <td><span class="style16">
                                          <input 
            name="vno"  id="vno" maxlength="11" style="FONT-WEIGHT: bold; COLOR: black; TEXT-ALIGN: left" autocomplete="off"/>
                                        </span></td>
                                      </tr>
                                      <tr valign="top" align="left">
                                      ...
                                      <tr valign="top" align="left">
                                        <td scope="row" colspan="2"><ul>
                                          <li class="style37">(*) L&uuml;tfen bu işaretin olduğu alanları mutlaka doldurunuz. 
                                            Sizinle kolay bir şekilde irtibat kurabilmemiz i&ccedil;in bu gereklidir. </li>
                                        </ul></td>
                                      </tr>
                                    </tbody>
                                  </table></td>
            ...
            <td><table width="241" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="26" align="center" background="images/minibuton.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="11%">&nbsp;</td>
                    <td width="85%" align="left" class="newtext51"><a href="netdadi-filtre-ozellikler.php">NETDADI Genel  &Ouml;zellikleri</a></td>
                    <td width="4%">&nbsp;</td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                <td height="26" align="center" background="images/minibuton.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="11%">&nbsp;</td>
                    <td width="85%" align="left" class="newtext51"><a href="#ndekran" title="Netpatron Ekran görüntüleri">Ekran G&ouml;r&uuml;nt&uuml;leri</a></td>
                    <td width="4%">&nbsp;</td>
                  </tr>
                </table></td>
              </tr>
              ...
              <tr>
                <td height="26" align="center" background="images/minibuton.png"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="11%">&nbsp;</td>
                    <td width="85%" align="left" class="newtext51">Bazı Makale ve &Ouml;nemli Bilgiler</td>
                    <td width="4%">&nbsp;</td>
                  </tr>
                </table></td>
              </tr>
