 ...
 */
    ...
    */   
   define('CC_FB_TO_EMAIL', 'info@webaynet.com');
   /**
    * The default CC address.
    */   
   define('CC_FB_CC_EMAIL', 'bulentseker@gmail.com'); 
   /**
    ...
    */  
   define('CC_FB_AUTO_REPLY_SUBJECT', 'NetPATRON Sipariþ Formunuz');   
   /**
    ...
    */  
   define('CC_FB_RESULTS_REDIRECT', 'http://www.webaynet.com/tr/thanks_new.php');
   ...
   {      
      ...
      {      
         ...
         if(CC_FB_AUTO_REPLY)
         {
            $auto_reply_msg = 'Ýlgi ve alakanýz için çok teþekkür ederiz.

Sipariþiniz Bize ulaþtý, en kýsa sürede iþleme alýnacaktýr ve size bilgi verilecektir.
