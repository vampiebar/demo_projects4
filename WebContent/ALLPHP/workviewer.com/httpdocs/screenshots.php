...
<meta name="description" content="Workviewer Ekran Görüntüleri Sayfası" />
<meta name="Robots" content="index,follow" />
<title>Workviewer | Ekran Görüntüleri</title>
...
<div class="topmenu">
    ...
    <div class="menu">
    	<ul>
            ...
            <li class="active"><a href="/ekran-goruntuleri"><?php echo $dil["ekran_goruntuleri_big"]; ?></a></li>
...
<div id="breadcrumb">
			<ul class="crumbs">
				...
				<li><a href="screenshots.php" style="z-index:8;"><?php echo $dil["ekran_goruntuleri"]; ?></a></li>
			</ul>
            <div class="clearfix"></div>
	</div>
	...
	for($i=1;$i<15;$i++){
		echo '
		<li>
        <a href="img/screens/'.$i.'.jpg" rel="lightbox[gallery]" title="'.$i.'. Ekran Görüntüsü">
            <img src="img/screens/kucuk/'.$i.'.png"/>
            <div><span>Workviewer</span></div>
        </a>
    	</li>
		';
		}
