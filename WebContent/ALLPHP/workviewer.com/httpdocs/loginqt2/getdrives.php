...
<div class="input-group" style="margin-bottom:10px;">
	<span class="input-group-addon driver_addon">Sürücü:</span>
  		<input type="text" class="form-control filename" placeholder="Örn:.exe,notepad.exe">
  	<span class="input-group-btn">
    	<button class="btn btn-primary searchit" type="button">Ara!</button>
  	</span>
</div>
<?php
    ...
    <div class="panel-heading">
      <h4 class="panel-title" style="font-size:12px;">
        <a class="accordion-toggle drivername" data-toggle="collapse" data-parent="#surucu" href="#surucu<?php echo $i; ?>">
          <i class="icon-database-1"></i> <span class="drivername_text"><?php echo $xml->get_proc_drives->drives[$i]; ?></span> Sürücüsü
        </a>
      </h4>
    </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <div class="alert alert-danger text-center" style="margin-bottom:0px;">
         	<p>Lütfen aranacak dosyanın tam adını giriniz.</p>
         </div>
        </div>
