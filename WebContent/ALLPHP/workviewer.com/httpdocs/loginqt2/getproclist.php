		...
		$(".addwsr").addClass("disabled").attr("disabled","disabled");
			$.ajax({
				...
				success:function(cevap){
					$("#newar").modal('hide');
					$(".modal-backdrop").hide();
					$(".proc_list").html('<i style="font-size:50px; color:#0477bd; margin-top:30px; display:inline-block" class="icon-spin2 animate-spin"></i><p style="margin-top:10px;">Lütfen Bekleyiniz. Uygulama Kısıtlama Listesi Alınıyor...</p>');
